...
public class WebBridge : MonoBehaviour
{
    ...
    public void ReceiveLandmarks(string jsonString)
    {
        ...
        // --- BƯỚC QUAN TRỌNG NHẤT: TÍNH TOÁN KÍCH THƯỚC WORLD SPACE CHO WEBGL ---
        ...
        {
            // Lấy khoảng cách từ Camera đến Parent Object (mặc định lấy 10 nếu quá gần)
            ...
            // Ép chiều rộng tuân theo tỷ lệ Webcam để giữ tỷ lệ cơ thể thực của người dùng
            worldWidth = worldHeight * webcamAspectRatio;
        }
